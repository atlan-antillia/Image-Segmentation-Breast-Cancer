...
# TensorflowUNetBreastCancerEvaluator.py
# 2023/05/10 to-arai
...
if __name__ == "__main__":
  try:
    ...
    images_datapath = config.get(EVAL, "image_datapath")
    masks_datapath  = config.get(EVAL, "mask_datapath")
   
    x_test, y_test = dataset.create(images_datapath, masks_datapath)
